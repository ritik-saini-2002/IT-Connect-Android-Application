...
object Permissions {
    ...
    const val PERM_MANAGE_COMPLAINTS            = "manage_complaints"
    const val PERM_ASSIGN_COMPLAINTS            = "assign_complaints"
    const val PERM_DELETE_COMPLAINTS            = "delete_complaints"
    const val PERM_EDIT_COMPLAINTS              = "edit_complaints"
    ...
    fun forRole(role: String): List<String> = when (role) {
        ...
        ROLE_ADMIN -> listOf(
            ...
            PERM_MANAGE_COMPLAINTS, PERM_ASSIGN_COMPLAINTS, PERM_DELETE_COMPLAINTS, PERM_EDIT_COMPLAINTS,
            // Feature access
        ...
        ROLE_MANAGER -> listOf(
            ...
            PERM_MANAGE_COMPLAINTS, PERM_ASSIGN_COMPLAINTS, PERM_EDIT_COMPLAINTS,
    ...
    val ALL_PERMISSIONS: List<String> = listOf(
        ...
        PERM_MANAGE_COMPLAINTS, PERM_ASSIGN_COMPLAINTS,
        PERM_DELETE_COMPLAINTS, PERM_EDIT_COMPLAINTS,
        // Super-role exclusives
