...
object PocketBaseInitializer {
    ...
    private var _adminTokenProvider: com.saini.ritik.core.AdminTokenProvider? = null

    fun setAdminTokenProvider(provider: com.saini.ritik.core.AdminTokenProvider) {
