...
interface DepartmentDao {
    ...
    suspend fun updateDepartmentStats(
        departmentId: String,
        userCount: Int,
        activeUsers: Int,
        lastUpdated: Long
    ...
    suspend fun updateComplaintStats(
        departmentId: String,
        totalComplaints: Int,
        openComplaints: Int,
        lastComplaintDate: Long?
    )
    ...
    // ── FIXED: was broken @MapColumn syntax ───────────────────
    ...
    suspend fun getDepartmentUserDistribution(
        companyName: String
    ): Map<@MapColumn(columnName = "department_name") String,
            @MapColumn(columnName = "user_count") Int>
}